		...
		<div class="container">
			...
			<div class="p-t-40">
				<p class="stext-107 cl6 txt-center">
					...
					<?= NOMBRE_EMPESA; ?> | <?= WEB_EMPRESA; ?> | | <a href="pqr/pqr_m.php">INPONGA SU PQR</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
			<div class="p-t-40">
				<p class="stext-107 cl6 txt-center">
					...
					Recuerde que su opinion es muy importante para mejorar nuestro servicios <a href="encuesta/index.php">encuesta</a>
